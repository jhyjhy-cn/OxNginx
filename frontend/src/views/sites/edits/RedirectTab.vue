<template>
  <div style="display: flex; gap: 8px; margin-bottom: 12px">
    ...
    <el-button
      v-if="redirectSelected.length > 0"
      type="danger"
      size="small"
      @click="batchDeleteRedirects"
    >
  ...
  <el-table
    :data="redirectRules"
    style="width: 100%"
    @selection-change="(val: RedirectRule[]) => (redirectSelected = val)"
  >
  ...
  <RedirectFormDialog
    v-model:visible="redirectFormVisible"
    :domains="domains"
    :rule="redirectFormTarget"
    @saved="onRedirectSaved"
  />
</template>
