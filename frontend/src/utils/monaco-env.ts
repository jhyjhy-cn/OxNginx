...
monaco.languages.setMonarchTokensProvider('nginx', {
  keywords: [
    'server', 'location', 'upstream', 'if', 'else', 'map', 'geo',
    'http', 'events', 'stream', 'mail', 'types', 'include',
    'worker_processes', 'worker_connections', 'keepalive_timeout',
    'proxy_pass', 'proxy_set_header', 'proxy_http_version',
    'proxy_cache', 'proxy_cache_valid', 'proxy_redirect',
    'return', 'rewrite', 'try_files', 'root', 'alias', 'index',
    ...
    'set', 'break', 'last', 'permanent', 'redirect',
    'expires', 'add_header', 'charset', 'gzip', 'gzip_types',
    'client_max_body_size', 'sendfile', 'tcp_nopush', 'tcp_nodelay',
    'autoindex', 'deny', 'allow', 'valid_referers',
    'ip_hash', 'least_conn', 'hash', 'keepalive',
    'weight', 'max_fails', 'fail_timeout', 'backup',
    'default_type', 'send_timeout', 'client_body_timeout',
